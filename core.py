...
def filter_timetable(timetable, line=[], destination=[], max_time=None, min_time=None):
    ...
    if destination:
        timetable = [i for i in timetable if i.get(u'destination', '') in destination]
...
class PiMVG(object):
    ...
    def _periodic_fun(self):
        ...
        for i in self.timetable:
            print(i['line'] + i['destination'] + ' leaving in: ' + unicode(str(i['minutes'])) + ' mins')  # Continue Iterating
